...
const style = computed(() => handleBackground(props.background, true, 0.5));
...
<template>
  <div class="slidev-layout cover" :style="style">
    <div class="my-auto w-full">
        ...
        <p class="text-#ffffff">{{ props.meeting }}</p>

        <div v-if="authorList.length" class="text-#ffffff">
